    ...
    return (
        <div className='text-center my-20'>
            <div className='space-y-5 text-center my-20'>
                ...
                <p className="text-white text-lg">Discover the trusted partners who help us deliver exceptional survey solutions.</p>
            </div>
            ...
            <div className='grid md:grid-cols-4 grid-cols-2 gap-5 mt-10'>
                {
                    partnerImg.map((image, index) =>
                        <Link key={index} to={'#'}><img
                            className='w-full h-24 bg-white bg-opacity-5 shadow shadow-[#00ffff9d] hover:shadow-inner rounded-lg p-5'
